...
export function Sidebar() {
  ...
  return (
    <nav className="w-60 shrink-0 border-r border-gray-200 dark:border-zinc-800 p-3 flex flex-col gap-1 bg-gray-50/50 dark:bg-zinc-900/30 backdrop-blur-sm h-full overflow-y-auto select-none">
      {/* Header with Toggle Filters Button */}
      <div className="flex items-center justify-between px-2 pb-2 border-b border-gray-200/55 dark:border-zinc-800/40 mb-1">
        ...
        <button
          ...
          className={`text-[10px] font-bold px-2 py-0.5 border rounded-md cursor-pointer select-none transition-all flex items-center gap-1 ${
            showFilters || isFilteringActive
              ...
              : "bg-white dark:bg-zinc-850 border-gray-300 dark:border-zinc-700 text-gray-500 dark:text-zinc-400 hover:text-zinc-750 dark:hover:text-zinc-200"
          }`}
        >
          <span>🔍</span>
