...
export const travelerElectroSeed: CharacterTalentSeed = {
  ...
  hits: [
    ...
    { hitKey: "skill-dmg", talentType: "skill", values: [78.72, 84.62, 90.53, 98.4, 104.3, 110.21, 118.08, 125.95, 133.82, 141.7, 149.57, 157.44, 167.28, 177.12] },

    // Elemental Burst — Bellowing Thunder
    { hitKey: "falling-thunder", talentType: "burst", values: [32.8, 35.26, 37.72, 41.0, 43.46, 45.92, 49.2, 52.48, 55.76, 59.04, 62.32, 65.6, 69.7, 73.8] },
    { hitKey: "falling-thunder-3rd", talentType: "burst", values: [32.8, 35.26, 37.72, 41.0, 43.46, 45.92, 49.2, 52.48, 55.76, 59.04, 62.32, 65.6, 69.7, 73.8] },
  ]
};
