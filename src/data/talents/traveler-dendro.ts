...
export const travelerDendroSeed: CharacterTalentSeed = {
  ...
  hits: [
    ...
    // Elemental Skill — Razor-Grass Blade
    { hitKey: "skill-dmg", talentType: "skill", values: [230.4, 247.68, 264.96, 288.0, 305.28, 322.56, 345.6, 368.64, 391.68, 414.72, 437.76, 460.8, 489.6, 518.4] },

    // Elemental Burst — Lea Lotus Lamp
    { hitKey: "lotus-dmg", talentType: "burst", values: [80.16, 86.17, 92.18, 100.2, 106.21, 112.22, 120.24, 128.26, 136.27, 144.29, 152.3, 160.32, 170.34, 180.36] },
    { hitKey: "transfiguration-explosion", talentType: "burst", values: [400.8, 430.86, 460.92, 501.0, 531.06, 561.12, 601.2, 641.28, 681.36, 721.44, 761.52, 801.6, 851.7, 901.8] },
  ]
};
