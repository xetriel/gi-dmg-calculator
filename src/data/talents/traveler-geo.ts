...
export const travelerGeoSeed: CharacterTalentSeed = {
  ...
  hits: [
    ...
    { hitKey: "rockslide", talentType: "normal", values: [60.0, 60.0, 60.0, 60.0, 60.0, 60.0, 60.0, 60.0, 60.0, 60.0, 60.0, 60.0, 60.0, 60.0] },
    ...
    { hitKey: "skill-dmg", talentType: "skill", values: [248.0, 266.6, 285.2, 310.0, 328.6, 347.2, 372.0, 396.8, 421.6, 446.4, 471.2, 496.0, 527.0, 558.0] },
    { hitKey: "c2-explosion", talentType: "skill", values: [248.0, 266.6, 285.2, 310.0, 328.6, 347.2, 372.0, 396.8, 421.6, 446.4, 471.2, 496.0, 527.0, 558.0] },

    // Elemental Burst — Wake of Earth
    { hitKey: "shockwave-dmg", talentType: "burst", values: [148.0, 159.1, 170.2, 185.0, 196.1, 207.2, 222.0, 236.8, 251.6, 266.4, 281.2, 296.0, 314.5, 333.0] },
  ]
};
