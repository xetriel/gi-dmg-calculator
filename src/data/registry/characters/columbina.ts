  ...
  talents: [
    {
      type: "normal", name: "Normal Attack — Moondew Cascade", hits: [
        ...
        { key: "moondew-cleanse", name: "Moondew Cleanse DMG (% Max HP ×3)", scaling: "hp", direct: "lunar", element: "Dendro" },
    ...
    },
    {
      type: "skill", name: "Elemental Skill — Eternal Tides", hits: [
        ...
        { key: "gi-charged", name: "Gravity Interference: Lunar-Charged DMG (% Max HP)", scaling: "hp", direct: "lunar", element: "Electro" },
        { key: "gi-bloom", name: "Gravity Interference: Lunar-Bloom DMG (% Max HP)", scaling: "hp", direct: "lunar", element: "Dendro" },
        { key: "gi-crystallize", name: "Gravity Interference: Lunar-Crystallize DMG (% Max HP)", scaling: "hp", direct: "lunar", element: "Geo" },
      ]
    },
    {
