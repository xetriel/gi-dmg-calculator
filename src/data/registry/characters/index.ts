...
export { arlecchino, huTao, neuvillette, clorinde, sandrone, zibai, nefer };
export const CHARACTERS: CharacterConfig[] = [arlecchino, huTao, neuvillette, clorinde, sandrone, zibai, nefer];
