...
export const kingsSquire: WeaponConfig = {
  ...
  passiveDesc:
    "Obtain the Teachings of the Forest effect when unleashing Elemental Skills and Bursts, increasing Elemental Mastery by 60~140 for 12s.",
  isSupport: false,
  buffType: "self",
  mechanicDefs: [
    {
      id: "kings-squire-active",
      label: "Teachings of the Forest Active",
      control: "toggle",
      defaultValue: 1,
      hint: "+60~140 Elemental Mastery",
    }
  ],
  buffs: [
    {
